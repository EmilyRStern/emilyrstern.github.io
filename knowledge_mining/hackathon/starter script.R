...
civic_cat <- c(
  "#2D6A5F",  # teal — keep your primary
  "#E69C24",  # golden amber — Okabe-Ito orange shifted warm
  "#5B7FA6",  # slate blue — safe against teal
  "#CC79A7",  # muted mauve/pink — Okabe-Ito pink, distinct from all
  "#8B4513",  # saddle brown — drop to 5th
  "#C8BFA8"   # tan — safe neutral
)
